...
class AdvertSkill
{
    ...
    public function setAdvert(Advert $advert)
    {
        ...
        // Modif du setter pour la relation bidirectionnelle avec advert
        // ici on choisit le coté proprietaire car on fait deja des setAdvert dans le controleur Advert
        $advert->addAdvertSkill($this);
    }
